...
<head>
    <meta charset="UTF-8">
    <title>Introducir contraseña - Amazon Clone</title>
    <style>
        ...
        .email-display { font-size: 14px; margin-bottom: 15px; }
...
<body>
    <div class="box">
        ...
        <div class="email-display">{{ $email }} <a href="{{ route('login.email') }}">Cambiar</a></div>
